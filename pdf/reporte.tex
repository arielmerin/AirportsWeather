...
Antes de analizar el problema, veamos una de las cuestiones más importantes, como es: ¿en qué lenguaje de programación nos conviene más hacer nuestro proyecto? Nuestra respuesta ante ésta pregunta es Python, y lo hemos elegido debido a que LA NETA NO SE PORQUE, HAY QUE AGREGARLE ALGO CHIDO XD
